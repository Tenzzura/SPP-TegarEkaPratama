                  ...
                  <div class="p-6 text-gray-900 dark:text-gray-100">
                      <form method="POST" action="{{ route('kelas.update', $kelas->id) }}">
                          ...
                          <div>
                              ...
                              <div class="relative">
                                  <x-text-input id="nama_kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" class="block mt-1 w-full 
                                  @error('nama_kelas') border-red-500 @enderror" 
                                  type="text" name="nama_kelas" placeholder="{{ $kelas->nama_kelas }}" required autocomplete="nama_kelas" />
                          ...
                          <div class="mt-4">
                              ...
                              <div class="relative">
                                  <x-text-input id="kompetensi_keahlian" value="{{ old('kompetensi_keahlian', $kelas->kompetensi_keahlian) }}" class="block mt-1 w-full 
                                  @error('kompetensi_keahlian') border-red-500 @enderror" 
                                  type="text" name="kompetensi_keahlian" placeholder="{{ $kelas->kompetensi_keahlian }}" required autocomplete="kompetensi_keahlian" />                                
                                  <!-- Error Icon -->
